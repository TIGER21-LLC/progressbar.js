...
this.removeAll())};p=p||{};u&&(m.setWidth(p.width||h.WIDTH),m.setHeight(p.height||h.HEIGHT),l.innerHTML="",l.setAttribute("class","progressbar-control"))};export default ProgressBar;
